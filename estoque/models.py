...
class Produto(models.Model):
    ...
    unidade_medida = models.CharField(max_length=3, choices=UNIDADES_MEDIDA, default="UN")
...
class Entrada(models.Model):
    ...
    numero_nota = models.CharField(max_length=50, blank=True, verbose_name="Número da Nota")
...
class Pedido(models.Model):
    ...
    setor = models.CharField(max_length=200, blank=True, verbose_name="Setor/Departamento")
    ...
    endereco_entrega = models.CharField(max_length=300, blank=True, verbose_name="Endereço de Entrega")
    programa = models.CharField(max_length=100, blank=True, verbose_name="Programa/Convênio")
    fornecedor = models.ForeignKey(Fornecedor, on_delete=models.PROTECT, null=True, blank=True, related_name="pedidos")
    licitacao = models.CharField(max_length=200, blank=True, verbose_name="Licitação/Contrato")
    numero_empenho = models.CharField(max_length=50, blank=True, verbose_name="Nº Empenho")
    empenho_anexo = models.FileField(upload_to="empenhos/", blank=True, null=True, verbose_name="Anexo de Empenho")
...
class ItemPedido(models.Model):
    ...
    produto = models.ForeignKey(Produto, on_delete=models.PROTECT)
    quantidade = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Qt. Pedida")
    quantidade_atendida = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name="Qt. Atendida")
    preco_unitario = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name="Preço Unit.")
