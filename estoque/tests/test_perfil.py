...
class PerfilUsuarioTemaTests(TestCase):
    def test_cria_perfil_automaticamente_para_novo_usuario(self) -> None:
    ...
    def test_salva_tema_no_perfil(self) -> None:
    ...
    def test_renderiza_tema_escolhido_no_body(self) -> None:
